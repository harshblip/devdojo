...
import Auth from "./../public/Authentication.png";
    ...
    <>
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 border-white p-3 shadow-2xl loginn">
          <div>
            <div className='ml-20'>
              <Image src={Auth} className="relative" height={240} width={240} />
            </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="rounded-md shadow-sm space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm ml-2 mr-2">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-400 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 disabled:cursor-not-allowed"
