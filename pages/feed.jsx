...
const FeedPage = ({ user }) => {
  ...
  return (
    <>
      <div className="container mx-auto px-6 py-8 md:px-12 md:py-10">
        <h1 className="text-black-600 text-2xl font-semibold mb-1">Your Feed</h1>
        ...
        {isFetchingNextPage && (
          <div className="py-8">
            <AiOutlineLoading3Quarters className="h-8 w-8 animate-spin mx-auto text-black-600" />
          </div>
        )}
      </div>
    </>
