        ...
        >
          {banner.name && banner.profilePicUrl ? (
            ...
            <div className="space-y-5">
              <div className="border border-black-600 rounded-full inline-flex p-5 items-center justify-center">
                <ChatAltIcon className="h-20 w-20 text-black-600" />
              </div>
...
export async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      ...
      title: 'Your Messages on DevDojo',
    },
  };
}
