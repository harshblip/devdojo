            ...
            <div className="mt-16 mx-auto max-w-7xl px-4 sm:px-6">
              <div className="text-center">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block h2 text-gray-400">web developers</span>
                </h1>
                ...
                <div className="mt-12 gap-x-4 gap-y-2 flex flex-wrap justify-center">
                  <Link href="/signup" legacyBehavior>
                    <a className="px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-black/80 hover:bg-white transition-all transition-0.4s hover:text-black md:py-3 md:text-lg md:px-6 inline-block">
                      Join Community
                    </a>
                  </Link>
