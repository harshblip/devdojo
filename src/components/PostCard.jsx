...
const PostCard = ({ post, user }) => {
  ...
  return (
    <Link href={`/posts/${post._id}`} className="z-40" legacyBehavior>
      <motion.div layout>
        <div className="rounded-lg group relative">
          <Image
            src="https://www.looper.com/img/gallery/every-power-sasuke-has-on-naruto-explained/intro-1663193400.jpg"
            alt={post.name}
            width={600}
            height={338}
